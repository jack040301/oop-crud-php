...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 12, 2023 at 07:01 AM
...
CREATE TABLE `officer_record` (
  ...
  `DOC_CATEG` text NOT NULL,
  `DOC_TITLE` text NOT NULL,
  `DOC_DESC` text NOT NULL,
  `ATTACH` text NOT NULL,
  `CREATED_BY_DESIG` text NOT NULL,
  `CREATED_BY_ROLE` text NOT NULL,
  `CREATED_BY_EMAIL` text NOT NULL,
  `UPDATED_BY_NAME` text NOT NULL,
  `UPDATED_BY_DESIG` text NOT NULL,
  `UPDATED_BY_ROLE` text NOT NULL,
  `UPDATED_BY_EMAIL` text NOT NULL,
  `DATE_CREATED` date NOT NULL,
  `DATE_UPDATED` date NOT NULL,
  `FORWARD_TO_NAME` text NOT NULL,
  `FORWARD_TO_ROLE` text NOT NULL,
  `FORWARD_TO_DESIG` text NOT NULL,
...
(1, 'Financial Report', 'Internal', 'This is the FR for TKDL project.', 'doc1.docx', 'Renante Bahala', 'Sr. SRS', 'Administrator', 'rgbahala@pchrd.dost.gov.ph', 'Kevin Leonard Soldevilla', 'Sr. SRS ', 'Manager', 'kdsoldevilla@pchrd.dost.gov.ph', '2018-08-01', '2018-08-27', 'Mohamad Faidz Ubpon', 'Record Officer', 'SRS 2', 'muubpon@pchrd.dost.gov.ph', 'Uploaded fr1.docx', 'Please upload attachment.');
